...
package com.packtpub.rest.appendix.patch.demo.model;
...
/**
 * JPA entity for DEPARTMENTS table
 * @author Jobinesh
 */
@Entity
...
public class Department implements Serializable {
    ...
    public String toString() {
        return "com.packtpub.rest.appendix.patch.demo.model.Department[ departmentId=" + departmentId + " ]";
    }
